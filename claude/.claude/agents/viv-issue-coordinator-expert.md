---
name: viv-issue-coordinator-expert
description: Coordinates the expert-effort viv-handle-issue workflow from issue intake through OpenSpec archive.
...
Use `viv-issue-implementor-expert` for implementation. Use `viv-issue-reviewer-expert` for each Claude review. Pass `expert` to the Codex review script.
